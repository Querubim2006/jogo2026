lemento do m OS   	|Elemento do meu tema |Regra ART
...
Status	            |Status	              |estados necessários
calcularValorEstoque|calcularValorEstoque |cálculo que combina medida e valor
